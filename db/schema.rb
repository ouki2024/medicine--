...
ActiveRecord::Schema.define(version: 2024_06_27_033046) do
  ...
  create_table "tag_relationships", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["review_id", "tag_id"], name: "index_tag_relationships_on_review_id_and_tag_id", unique: true
    t.index ["review_id"], name: "index_tag_relationships_on_review_id"
  ...
  add_foreign_key "tag_relationships", "reviews"
